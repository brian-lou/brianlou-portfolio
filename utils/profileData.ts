export const profile = {
  main: {
    ...
    bio: "Hey there! I’m a developer passionate about building tools that make developers’ lives easier. At General Translation, I’m currently rethinking localization with AI to help businesses go global seamlessly. Feel free to reach out if you’d like to chat about AI, startups, or anything else!",
    contactmessage: "",
    ...
    education: [
      {
        ...
        courses: {
          "Computer Science Courses:":
            "Algorithms and Data Structures, Natural Language Processing, Computer Vision, Intro to Machine Learning, Intro to Programming Systems, Advanced Programming Techniques, Economics and Computing, Computer Graphics, Human-Computer Interaction",
          "Math, Science, and Statistics Courses:":
            "Multivariable Calculus, Linear Algebra, General Physics, General Chemistry, Fundamentals of Statistics, Introduction to Data Science",
          "Economics and Finance Courses:":
            "Introduction to Microeconomics, Corporate Finance",
        },
        description: [],
      },
      {
        ...
        gpa: "4.6 Weighted",
        description: ["Graduated Summa Cum Laude", "National Merit Scholar"],
      },
    ],
    work: [
      {
      ...
      },
      {
        ...
        description: [
          "Worked with Colgate-Palmolive on generating novel 3D views from real-world 2D images using Neural Networks (NeRF)",
          "Worked with data collection software on an autonomous driving research car sponsored by Mercedes-Benz",
        ],
      },
      {
        company: "Zuora, Inc.",
  ...
  projects: [
    {
      title: "TigerSync",
      category:
        "A workout scheduling web app for Princeton athletes and coaches. Built using React and NextJS",
      image: "tigersync.jpg",
    ...
    // },
    {
      ...
      category:
        "Custom coded light-weight website for Skyblock Extras. Created with HTML, CSS, and Java Servlets",
    ...
    },
    {
      ...
      category:
        "A NLP project focused on the security vulnerabilities surrounding LLMs and their potential consequences",
      image: "nlpproject.png",
      url: "https://github.com/brianlou2024/NLPFinalProject",
    },
    {
      title:
        "Towards Efficient Frame Sampling Strategies for Video Action Recognition",
      category:
        "A Computer Vision project focused on investigating more efficient frame sampling strategies for the task of video action recognition",
      image: "cv.png",
